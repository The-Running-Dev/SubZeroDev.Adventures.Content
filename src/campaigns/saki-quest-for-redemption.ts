...
export const sakiQuestCatalog: import("@the-running-dev/game-engine/authoring").PortableCatalog =
  {
...
// ---------------------------------------------------------------------------
// Authoring helpers — shared with what-would-lucifer-do.ts and
// what-would-lucifer-do-engineers-cut.ts via _shared/story-graph-helpers.ts
// ---------------------------------------------------------------------------
...
pick(
  ...
  [
    opt(
      "prologue",
      "ask_again",
      "Ask again, patiently, like a normal person",
      "incident_1",
    ),
    opt(
      "prologue",
      "invent_one",
      "Announce that you will simply invent one yourself",
      "incident_1",
      {
    ...
    opt(
      "prologue",
      "send_a_message",
      "Close the laptop and send Saki four sentences",
      "speedrun_warning",
      {
    ...
    opt(
      "prologue",
      "read_changelog",
      "Read the changelog first, for no reason anyone can defend",
      "changelog",
      {
...
pick(
  ...
  [
    ...
    opt(
      "speedrun_warning",
      "speedrun_reconsider",
      "Delete it. Surely this deserves a proper quest.",
      "incident_1",
      {
        effects: [
          inc("common_sense_ignored"),
          inc("scope_creep"),
          dec("lucifer_dignity"),
        ],
      },
...
pick(
  ...
  [
    opt(
      "incident_1",
      "incident_review",
      "Review the conversation forensically",
      "incident_review_event",
      {
        effects: [inc("overthinking")],
      },
    ),
    opt(
      "incident_1",
      "incident_assume",
      "Assume the worst and proceed with dignity",
      "incident_review_event",
      {
    ...
    opt(
      "incident_1",
      "incident_ask",
      "Ask Saki whether anything is actually wrong",
      "common_sense_1",
    ),
  ],
);
...
fork(
  "incident_review_event",
  "The record is consulted. It is unhelpful in two distinct ways.",
  [
...
pick(
  ...
  [
    opt(
      "incident_3",
      "class_minor",
      "Minor Friendship Incident",
      "incident_classified",
      { effects: [put("severity", "minor")] },
    ),
    opt(
      "incident_3",
      "class_two",
      "Class-II Conversational Miscalculation",
      "incident_classified",
      {
    ...
    opt(
      "incident_3",
      "class_opinion",
      "Unauthorized Deployment of Opinion",
      "incident_classified",
      {
        effects: [
          put("severity", "unauthorized_opinion"),
          dec("lucifer_dignity"),
        ],
      },
    ),
    opt(
      "incident_3",
      "class_observability",
      "Failure of Interpersonal Observability",
      "incident_classified",
      {
    ...
    opt(
      "incident_3",
      "class_integrity",
      "Friendship Integrity Check Failure",
      "incident_classified",
      {
...
pick(
  ...
  [
    opt("incident_4", "take_seriously", "Take it seriously", "act2_open", {
      effects: [inc("redemption_progress")],
    }),
    opt(
      "incident_4",
      "take_theatrically",
    ...
    opt(
      "incident_4",
      "take_lightly",
      "Take it lightly, which will not last",
      "act2_open",
...
pick(
  ...
  [
    opt(
      "infra_1",
      "infra_back",
      "Return to the quest, now with tooling",
      "act2_open",
      { effects: [inc("redemption_progress")] },
    ),
    opt(
      "infra_1",
      "infra_more",
      "Add a second service, because the first one looked lonely",
      "act2_open",
      {
        effects: [
          inc("infrastructure", 2),
          inc("scope_creep", 2),
          dec("lucifer_dignity"),
        ],
      },
...
pick(
  ...
  [
    opt(
      ...
      "tribunal_conscience",
      { showWhen: unvisited("tribunal_conscience") },
    ),
    opt(
      "tribunal_hub",
      "consult_common_sense",
    ...
    opt(
      "tribunal_hub",
      "consult_bureaucrat",
      "Consult an imaginary bureaucrat",
      "tribunal_bureaucrat",
      { showWhen: unvisited("tribunal_bureaucrat") },
    ),
    opt(
      "tribunal_hub",
      "consult_god",
      "Consult God, who is awake and mildly interested",
      "tribunal_god",
      { showWhen: unvisited("tribunal_god") },
    ),
    opt(
      "tribunal_hub",
      "consult_agent",
      "Consult an AI agent",
      "tribunal_agent",
      { showWhen: unvisited("tribunal_agent") },
    ),
    opt("tribunal_hub", "consult_self", "Consult Lucifer", "tribunal_self", {
      showWhen: unvisited("tribunal_self"),
    }),
    opt(
      "tribunal_hub",
      "consult_questlog",
      "Consult a completely inappropriate RPG quest log",
      "tribunal_questlog",
      { showWhen: unvisited("tribunal_questlog") },
    ),
    opt(
      "tribunal_hub",
      "full_bench",
      "Convene the full bench, which has never been done and should not be",
      "tribunal_full_bench",
      {
        showWhen: {
          all: [
    ...
    opt(
      "tribunal_hub",
      "conclude",
      "Declare the tribunal concluded",
      "tribunal_verdict",
      { effects: [put("tribunal_completed", true)] },
    ),
  ],
);
...
pick(
  ...
  [
    opt(
      "tribunal_conscience",
      "conscience_accept",
      "Accept that there may be no offense",
      "tribunal_hub",
      {
    ...
    opt(
      "tribunal_conscience",
      "conscience_reject",
      "Reject the finding on procedural grounds",
      "tribunal_hub",
      {
...
pick(
  ...
  [
    opt("common_sense_1", "obey", "Just talk to Saki", "saki_direct", {
      effects: [
        put("talked_to_saki", true),
        inc("saki_approval", 2),
        inc("redemption_progress", 2),
      ],
    }),
    opt(
      "common_sense_1",
      "decline_scaffolded",
      "Decline: the quest is already scaffolded",
      "tribunal_hub",
      {
    ...
    opt(
      "common_sense_1",
      "decline_philosophy",
      "Decline: the nature of apology must first be established",
      "tribunal_hub",
      {
    ...
    opt(
      "common_sense_1",
      "decline_infrastructure",
      "Decline: build infrastructure",
      "tribunal_hub",
      {
...
pick(
  ...
  [
    ...
    opt(
      "tribunal_bureaucrat",
      "ask_consent",
      "Ask where the consent field is",
      "consent_field",
      {
...
pick(
  ...
  [
    opt(
      "tribunal_god",
      "answer_honestly",
      "Answer honestly: more of this",
      "tribunal_hub",
      {
        effects: [inc("scope_creep", 2), dec("lucifer_dignity")],
      },
    ),
    opt("tribunal_god", "deflect", "Deflect into cosmology", "tribunal_hub", {
...
pick(
  ...
  [
    ...
    opt(
      "tribunal_agent",
      "ask_short",
      "Ask for the shortest possible version",
      "agent_short",
...
pick(
  ...
  [
    opt(
      "tribunal_self",
      "ratify",
      "Ratify your own opinion unanimously",
      "tribunal_hub",
      {
        effects: [inc("overthinking"), dec("lucifer_dignity")],
      },
    ...
    opt(
      "tribunal_self",
      "dissent",
      "Dissent from yourself, for balance",
      "tribunal_hub",
      { effects: [inc("philosophy")] },
    ),
  ],
...
pick(
  ...
  [
    opt(
      "tribunal_full_bench",
      "minute_it",
      "Minute the unanimous finding and ignore it",
      "tribunal_verdict",
      {
    ...
    opt(
      "tribunal_full_bench",
      "adjourn",
      "Adjourn the bench and go talk to Saki",
      "saki_direct",
      {
        effects: [
          put("talked_to_saki", true),
...
pick(
  ...
  [
    opt(
      ...
      "trial_reflection_1",
      { showWhen: unvisited("trial_reflection_1") },
    ),
    opt(
      "trials_hub",
      "trial_apology",
      "The Trial of the Apology",
      "trial_apology_1",
      { showWhen: unvisited("trial_apology_1") },
    ),
    opt("trials_hub", "trial_gift", "The Trial of the Gift", "trial_gift_1", {
      showWhen: unvisited("trial_gift_1"),
    }),
    opt(
      "trials_hub",
      "trial_restraint",
      "The Trial of Restraint, which is already going badly",
      "trial_restraint_1",
      {
        showWhen: {
          all: [atLeast("overthinking", 3), unvisited("trial_restraint_1")],
        },
      },
    ),
    opt(
      "trials_hub",
      "trials_done",
      "Declare the trials complete",
      "act4_open",
      {
        requirements: atLeast("redemption_progress", 2),
        requirementFail:
          "The quest log declines. You have not yet suffered procedurally.",
      },
    ),
    opt(
      "trials_hub",
      "trials_abandon",
      "Abandon the trials; they were self-imposed anyway",
      "act4_open",
      {
        effects: [inc("lucifer_dignity")],
      },
...
pick(
  ...
  [
    ...
    opt(
      "trial_reflection_1",
      "reflect_ask_ai",
      "Ask an AI to reflect on your behalf",
      "reflection_event",
      {
...
fork(
  "reflection_event",
  "Reflection produces a result. Reflection was never asked what kind of result.",
  [
    { weight: 1, effects: [inc("philosophy")], goto: "reflection_result_a" },
    {
      weight: 1,
      effects: [inc("redemption_progress")],
      goto: "reflection_result_b",
    },
  ],
);
...
pick(
  ...
  [
    ...
    opt(
      "trial_apology_1",
      "apology_formal",
      "Overly formal, with a reference number",
      "apology_result",
      {
        effects: [
          put("apology_form", "formal"),
          inc("overthinking"),
          inc("redemption_progress"),
        ],
      },
    ...
    opt(
      "trial_apology_1",
      "apology_legal",
      "Legally defensive, admitting nothing",
      "apology_result",
      {
        effects: [
          put("apology_form", "legal"),
          dec("lucifer_dignity", 2),
          dec("saki_approval"),
        ],
      },
    ),
    opt(
      "trial_apology_1",
      "apology_rpg",
      "As RPG dialogue, with three response options for Saki",
      "apology_result",
      {
        effects: [
          put("apology_form", "rpg"),
          inc("scope_creep"),
          inc("philosophy"),
        ],
      },
    ...
    opt(
      "trial_apology_1",
      "apology_campaign",
      "Skip the apology and build an entire interactive campaign instead",
      "apology_campaign_node",
      {
        effects: [
          put("apology_form", "campaign"),
          inc("scope_creep", 3),
          inc("infrastructure", 3),
          dec("lucifer_dignity", 2),
        ],
...
say(
  "apology_result",
  "The apology is filed.\n\nFiled. A word that should never appear anywhere near an apology, and which has now appeared twice.",
  "trials_hub",
);
...
pick(
  ...
  [
    opt(
      "trial_gift_1",
      "gift_drink",
      "A drink, in person, with no agenda",
      "gift_result",
      {
    ...
    opt(
      "trial_gift_1",
      "gift_story",
      "The story he asked for, finally written",
      "gift_result",
      {
        effects: [
          inc("saki_approval", 2),
    ...
    opt(
      "trial_gift_1",
      "gift_repo",
      "A private repository, with a README and a licence",
      "gift_result",
      {
        effects: [
          inc("infrastructure", 2),
...
say(
  "gift_result",
  "The gift is prepared. It waits by the door with the calm of an object that does not know what it is part of.",
  "trials_hub",
);
...
pick(
  ...
  [
    ...
    opt(
      "trial_restraint_1",
      "restraint_fail",
      "Open the campaign file to check one small thing",
      "restraint_result",
      {
        effects: [
          inc("scope_creep", 2),
    ...
    opt(
      "trial_restraint_1",
      "restraint_philosophy",
      "Consider whether doing nothing is itself an action",
      "restraint_result",
      {
...
say(
  "restraint_result",
  "The minute passes. Somewhere, quietly, it is recorded.",
  "trials_hub",
);
...
say(
  "act4_open",
  "ACT IV — THE ARITHMETIC\n\nThe narrator would like to raise something.",
  "meta_1",
);
...
pick(
  ...
  [
    opt(
      "meta_1",
      "meta_accept",
      "Acknowledge the arithmetic and keep going",
      "meta_event",
      { effects: [inc("scope_creep")] },
    ),
    opt(
      "meta_1",
      "meta_defend",
      "Argue that the four sentences would have been worse",
      "meta_event",
      {
...
fork(
  "meta_event",
  "The fourth wall is load-bearing here, and has begun making a noise.",
  [
...
pick(
  ...
  [
    opt("meta_2", "ship", "Ship it and go find Saki", "act5_open", {
      effects: [inc("redemption_progress", 2)],
    }),
    opt(
      "meta_2",
      "more_infrastructure",
      "Build more infrastructure first",
      "infra_2",
      {
        effects: [
          inc("infrastructure", 3),
    ...
    opt("meta_2", "delete", "Delete the whole thing", "meta_delete_node", {
      effects: [inc("lucifer_dignity", 2)],
    }),
    opt(
      "meta_2",
      "philosophy",
      "Determine whether redemption is a social construct",
      "philosophy_node",
      {
...
pick(
  ...
  [
    opt(
      "infra_2",
      "carry_on",
      "Go to Saki anyway, carrying repositories",
      "act5_open",
      { effects: [inc("scope_creep")] },
    ),
    opt(
      "infra_2",
      "commit_fully",
      "Commit to the infrastructure. Fully. Permanently.",
      "ending_scope_creep",
      {
        effects: [
          inc("infrastructure", 4),
          inc("scope_creep", 4),
          dec("lucifer_dignity", 3),
        ],
      },
    ),
  ],
...
pick(
  ...
  [
    ...
    opt(
      "philosophy_node",
      "abandon",
      "Abandon cosmology and go find your friend",
      "act5_open",
      {
        effects: [inc("redemption_progress"), inc("lucifer_dignity")],
      },
...
pick(
  ...
  [
    opt(
      "saki_1",
      "explain",
      "Explain yourself immediately, at length",
      "saki_event",
      { effects: [inc("overthinking")] },
    ),
    opt("saki_1", "say_nothing", "Say nothing and let it load", "saki_event", {
      effects: [inc("lucifer_dignity")],
    }),
    opt("saki_1", "lead_with_apology", "Lead with the apology", "saki_event", {
      requirements: {
        field: "var.apology_form",
        operator: "not_equals",
        value: "none",
      },
      requirementFail:
        "You never actually wrote one. Five acts, and no apology.",
...
fork(
  "saki_event",
  "Saki reads. The pause is not long, but it is structurally significant.",
  [
...
pick(
  ...
  [
    opt(
      "saki_direct",
      "write_the_story",
      "Write him the story. No engine. No schema. Just the story.",
      "ending_normal_adult",
      {
        effects: [
          inc("saki_approval", 3),
          inc("redemption_progress", 3),
          inc("lucifer_dignity", 2),
        ],
      },
    ),
    opt(
      "saki_direct",
      "end_here",
      "End it here, with the friendship intact and no deliverable",
      "ending_speedrun",
      {
    ...
    opt(
      "saki_direct",
      "relapse",
      "Agree warmly, then quietly open the campaign file",
      "saki_judgment",
      {
        effects: [
          inc("common_sense_ignored", 2),
          inc("scope_creep", 2),
          dec("lucifer_dignity", 2),
        ],
      },
...
pick(
  ...
  [
    opt("saki_judgment", "judge_redeemed", "Redemption", "ending_redeemed", {
      requirements: {
        all: [atLeast("redemption_progress", 5), atLeast("saki_approval", 3)],
      },
      requirementFail:
        "Redemption is a state, not a button. The state is not met.",
    }),
    opt(
      "saki_judgment",
      "judge_idiot",
    ...
    opt(
      "saki_judgment",
      "judge_recursive",
      "Note his one objection, and open a new file",
      "ending_content_pipeline",
      {
        showWhen: {
          all: [flag("consent_field_checked", true), atLeast("scope_creep", 4)],
        },
      },
    ),
    opt(
      "saki_judgment",
      "judge_philosophy",
      "Deliver the cosmology",
      "ending_philosophical",
      { showWhen: atLeast("philosophy", 4) },
    ),
    opt(
      "saki_judgment",
      "judge_scope",
      "Explain that this could easily be a series",
      "ending_scope_creep",
      { effects: [inc("scope_creep", 2)] },
    ),
    opt(
      "saki_judgment",
      "judge_unresolved",
      "Say nothing and close the laptop",
      "ending_unresolved",
    ),
  ],
);
...
const ENDING_ACHIEVEMENTS: readonly (readonly [string, string, string])[] = [
  [
    "redeemed",
    "Redeemed",
    "Be forgiven for a thing that may not have happened.",
  ],
  [
    "speedrun",
    "Speedrun",
    "Resolve the entire campaign by behaving like an adult.",
  ],
  [
    "scope_creep",
    "Scope Creep",
    "Answer an emotional problem with three repositories.",
  ],
  [
    "alan_watts",
    "Alan Watts Cannot Help You Here",
    "Win the argument and lose the point.",
  ],
  [
    "content_pipeline",
    "Content Pipeline",
    "Convert your friend's objection into the next story arc.",
  ],
  [
    "you_are_an_idiot",
    "You Are An Idiot",
    "Receive the smallest possible reaction to the largest possible gesture.",
  ],
  [
    "seen_by_nobody",
    "Seen By Nobody",
    "Ship a private campaign to an audience of zero.",
  ],
  [
    "normal_human_being",
    "Normal Human Being",
    "Write the story he actually asked for.",
  ],
];
...
const achievements: AchievementDefinitionSource[] = [
  ...ENDING_ACHIEVEMENTS.map(([id, name, description]) =>
    achievement(id, name, description, {
      field: "ending",
      operator: "equals",
      value: ENDING_FOR_ACHIEVEMENT[id],
    }),
  ),
  achievement(
  ...
  achievement(
    "architecture_zero",
    "Architecture: 0",
    "Build six units of infrastructure for a conversation.",
    atLeast("infrastructure", 6),
  ),
  achievement(
    "no_consent_field",
    "The Data Contract Has No Consent Field",
    "Ask the one question the schema cannot answer.",
    flag("consent_field_checked", true),
  ),
  achievement(
    "common_sense_was_right",
    "Common Sense Was Right",
    "Ignore the correct advice four separate times.",
    atLeast("common_sense_ignored", 4),
  ),
  achievement(
    "dignity_underflow",
    "Dignity: Underflow",
    "Reduce Lucifer's dignity to nothing at all.",
    { field: "var.lucifer_dignity", operator: "less_or_equal", value: 0 },
  ),
  achievement(
    "read_the_changelog",
    "Who Reads The Changelog",
    "Find the commit that predates the decision to write it.",
    visited("changelog"),
  ),
  achievement(
    "full_bench",
    "The Full Bench",
    "Consult every authority except the one that matters.",
    visited("tribunal_full_bench"),
  ),
  achievement(
    "load_bearing_marble",
    "Load-Bearing Marble",
    "Commission a statue of a man who did not ask for one.",
    visited("gift_statue"),
  ),
  achievement(
    "procedurally_insufficient",
    "Procedurally Insufficient",
    "Reach the fifth act without producing an apology.",
    {
      all: [
        visited("saki_1"),
        { field: "var.apology_form", operator: "equals", value: "none" },
      ],
    },
  ),
];
...
const TITLE: AuthoredText = {
  key: "saki.campaign.title",
  text: "Saki: Quest for Redemption",
};
...
export const sakiQuestSource: StoryGraphCampaignSource = {
  ...
  variables: {
    saki_approval: {
      ...
      max: 12,
      visible: true,
      label: text("var_saki_approval", "label", "Saki Approval"),
    },
    lucifer_dignity: {
      type: "int",
      initial: 4,
      ...
      max: 10,
      visible: true,
      label: text("var_lucifer_dignity", "label", "Lucifer Dignity"),
    },
    redemption_progress: {
      type: "int",
      initial: 0,
      ...
      max: 16,
      visible: true,
      label: text("var_redemption_progress", "label", "Redemption Progress"),
    },
    overthinking: {
      type: "int",
      initial: 0,
      ...
      max: 12,
      visible: true,
      label: text("var_overthinking", "label", "Overthinking"),
    },
    infrastructure: {
      type: "int",
      initial: 0,
      ...
      max: 16,
      visible: true,
      label: text("var_infrastructure", "label", "Infrastructure Built"),
    },
    common_sense_ignored: {
      type: "int",
      initial: 0,
      min: 0,
      max: 12,
      visible: true,
      label: text("var_common_sense_ignored", "label", "Common Sense Ignored"),
    },
    scope_creep: {
      type: "int",
      initial: 0,
      ...
      max: 16,
      visible: true,
      label: text("var_scope_creep", "label", "Scope Creep"),
    },
    philosophy: {
      type: "int",
      initial: 0,
      ...
      max: 12,
      visible: true,
      label: text("var_philosophy", "label", "Philosophical Detours"),
    },
    severity: {
      type: "enum",
    ...
    apology_form: {
      type: "enum",
      initial: "none",
      values: ["none", "sincere", "formal", "legal", "rpg", "campaign"],
    },
...
export function buildSakiQuestCampaign(
  source: StoryGraphCampaignSource = sakiQuestSource,
